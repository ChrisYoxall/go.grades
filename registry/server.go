...
func (r *registry) sendPatch(p patch, url string) error {
	...
	// Ignoring the response here. In a production environment, you would want to check the response
	// to make sure it was successful, and if not, you would want to retry the request.
